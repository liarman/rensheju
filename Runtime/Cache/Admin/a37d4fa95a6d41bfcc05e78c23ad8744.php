...
<table id="linkGrid" class="easyui-datagrid" style="width:92%;height:800px" url="<?php echo U('Admin/Link/ajaxLinkList');?>" pagination="true"  toolbar="#toolbar" singleSelect="true" rownumbers="true">
    <thead>
    <tr>
        ...
        <th field="cat" width="200" formatter="formatCat">分类</th>
    </tr>
    </thead>
</table>
<div id="toolbar">
    ...
    <form id="addLinkForm" method="post">
        <table>
            ...
            <tr>
                <td>分类:</td>
                <td>
                    <select class="easyui-combobox " id="linkcatadd" name="cat">
    ...
    <form id="editLinkForm" method="post">
        ...
        <table>
            ...
            <tr>
                <td>分类:</td>
                <td>
                    <select class="easyui-combobox " id="linkcatedit" name="cat">
...
<script type="text/javascript">
    ...
    function editLink(){
        ...
        if (row){
            ...
            url ="<?php echo U('Admin/Link/edit');?>"+'/id/'+row.id;
        }
    }
    function destroyLink(){
        ...
        if (row){
            $.messager.confirm('删除提示','真的要删除?',function(r){
                if (r){
                    var durl="<?php echo U('Admin/Link/delete');?>";
