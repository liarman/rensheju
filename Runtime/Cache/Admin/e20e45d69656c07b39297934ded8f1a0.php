...
<table id="newscatGrid" class="easyui-treegrid" style="width:92%;height:800px" url="<?php echo U('Admin/News/ajaxCatsList');?>" toolbar="#toolbar" idField="id" treeField="name" >
    <thead>
    <tr>
...
<script type="text/javascript">
    ...
    function addNewscat(id){
        ...
        if(id>0){
            ...
            $.getJSON("<?php echo U('Admin/News/getCat');?>/id/"+id,function(data){
                $(".parent").empty().append(data.name);
            })
        }
        url="<?php echo U('Admin/News/addCat');?>";
    }
    ...
    function editNewscat(id){
        if(id>0){
            ...
            url ="<?php echo U('Admin/News/editCat');?>"+'/id/'+id;
            $.getJSON("<?php echo U('Admin/News/getCat');?>/id/"+id,function(data){
    ...
    function destroyNewscat(){
        ...
        if (row){
            $.messager.confirm('删除提示','真的要删除?',function(r){
                if (r){
                    var durl="<?php echo U('Admin/News/deleteCat');?>";
