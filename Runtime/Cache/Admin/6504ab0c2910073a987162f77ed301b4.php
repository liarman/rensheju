...
<form class="form-inline" method="post" id="addstore">
    <table class="table table-striped table-bordered table-hover table-condensed">
        <tr>
            ...
            <td>
                <input class="form-control required"  type="text" name="name" tip="请输入用户名">
            </td>
        </tr>
        <tr>
            <th>联系人</th>
            <td>
                <input class="form-control required" type="text" name="contact" tip="请输入用户名">
            </td>
        </tr>
        <tr>
            <th>地址</th>
        ...
        <tr>
            <th>联系电话</th>
            <td>
                <input class="form-control isPhone" type="text" name="phone">
            </td>
        </tr>
        <tr>
            <th></th>
